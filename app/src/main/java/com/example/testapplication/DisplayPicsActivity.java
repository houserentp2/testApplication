...
public class DisplayPicsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_pics);
        createToolbar();
    ...
    private void createToolbar() {
        ...
        getSupportActionBar().setTitle(R.string.display_pic_title);
    ...
    public void destory_activity(View view){
        finish();
    }
